...
interface SeoPageConfig {
  ...
  metaDesc: string
  intro: string
  query: string // SQL WHERE clause fragment for vision_data join
}
...
const SEO_PAGES: SeoPageConfig[] = [
  ...
  },
  {
    ...
    metaTitle: "Spring Outfits for Women — 200+ Styled Looks | VibéShop",
    ...
    query: `v.season = 'spring'`,
  },
  {
    slug: "spring-outfit-ideas",
    title: "Spring Outfit Ideas",
    keyword: "spring outfit ideas",
    metaTitle: "Spring Outfit Ideas — Fresh Inspiration from Julia Berolzheimer | VibéShop",
  ...
  },
  {
    ...
    metaTitle: "Spring Capsule Wardrobe — Julia Berolzheimer's Essential Pieces | VibéShop",
  ...
  },
  {
    ...
    metaTitle: "Spring Fashion 2026 — The Newest Looks from Julia Berolzheimer | VibéShop",
