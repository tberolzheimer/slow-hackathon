...
// IMPORTANT: sorted longest-first at runtime, so multi-word brands match before
// the fallback "first word = brand" rule. Keep this list comprehensive to avoid
// truncated brands like "Bottega" instead of "Bottega Veneta".
const KNOWN_BRANDS = [
  // 5+ word brands
